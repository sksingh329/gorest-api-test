...
def test_create_user(): 
    ...
    response = requests.post(url= USERS_ENDPOINT, headers=headers, data=create_user_payload)
    response_body = response.json()
...
def test_get_user():
    ...
    create_user_response = requests.post(url= USERS_ENDPOINT, headers=headers, data=create_user_payload)
...
def test_put_user():
    ...
    update_user_response = requests.put(url=USER_ENDPOINT.format(user_id=user_id), headers=headers, data=update_user_payload)
